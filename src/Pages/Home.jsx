...
const WORDS = ["Mahasiswa UPN 2025", "Fakultas Ilmu Komputer","Prodi Informatika"];
const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
 
  { icon: Linkedin, link: "https://www.linkedin.com/in/raditia-novandra-892311374?trk=contact-info" },
  { icon: Instagram, link: "https://www.instagram.com/rnvannsyah_/" },
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                  data-aos="fade-up"
                  data-aos-delay="1000">
                 Sebuah website portofolio singkat dengan tampilan yang sederhana
                </p>
